  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-secondary/20 to-primary/5 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-gradient-to-r from-accent/10 to-success/10 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="space-y-4">
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto font-medium">
              Proven Digital Marketing Strategist | Scaling Brands with
              Data-Driven ROAS
            </p>
            <p className="text-lg text-muted-foreground/80 max-w-2xl mx-auto">
              Trusted by Fortune 500 companies and growing startups to deliver
              measurable growth through performance marketing
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <Button
              size="lg"
              className="bg-gradient-primary hover:opacity-90 text-white px-8 py-6 text-lg font-semibold shadow-elegant"
